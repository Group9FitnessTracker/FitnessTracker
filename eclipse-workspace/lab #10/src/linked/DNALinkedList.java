...
public class DNALinkedList 
{
    ...
    public void transpose(String transposon, String target)
    {
        ...
        if (firstNodeOfTransposon == null) {
        	throw new IllegalArgumentException("transposon not in list");
        }
        ...
        if (firstNodeOfTarget == null) {
            throw new IllegalArgumentException("target not in list");
        }
    ...
    public static void main(String[] args)
    {
    	...
    	//test case 2 target at head
        //test case 3 target at tail
